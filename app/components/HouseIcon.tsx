export default function HouseIcon({ size = 28, className = "" }: { size?: number; className?: string }) {
  return (
    ...
    >
      ...
      <rect x="82" y="104" width="28" height="40" rx="3" fill="#09090b" />
      <circle cx="104" cy="126" r="2.5" fill="currentColor" />
      <rect x="60" y="92" width="18" height="16" rx="2" fill="#09090b" opacity="0.7" />
      <rect x="114" y="92" width="18" height="16" rx="2" fill="#09090b" opacity="0.7" />
    </svg>
  );
}
